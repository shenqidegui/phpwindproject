                           ...
                           <form role="form" action="<?php echo U('Admin/Cate/insert');?>" method="post" enctype="multipart/form-data">
                               <div class="form-group">
                                   ...
                                   <select name="pid" class="form-control">
                                      ...
                                      <?php if(is_array($cates)): foreach($cates as $k=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                                   </select>
                               </div>

                               <div class="form-group">
                                   <label>分类名称</label>
                                   <input name="name" placeholder="请输入6~18位数字,字母,下划线" class="form-control">
                               </div>
