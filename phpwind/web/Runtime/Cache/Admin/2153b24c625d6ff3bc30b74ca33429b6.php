						...
						<div class="col-xs-12">
							<div class="table-responsive">
								<table id="sample-table-1" class="table table-striped table-bordered table-hover">
									...
									<div class="row">
									  <div class="col-sm-6">
									    <div id="sample-table-2_length" class="dataTables_length">
									      <form action="<?php echo U('Admin/Card/index');?>" method="post" >
									  ...
									  <div class="col-sm-6">
									    <div class="dataTables_filter" id="sample-table-2_filter">
									      <label>搜索: 
									        <input id="search" type="text" name="title" aria-controls="sample-table-2" placeholder="请输入标题" value="<?php echo ($_GET['keyword']); ?>">
									      </label>
									...
									<tbody>
									<?php if(is_array($cards)): foreach($cards as $key=>$val): ?><tr>
											<td class="center">
												<label>
													<input type="checkbox" class="ace" />
													<span class="lbl"></span>
											...
											<td class="sid"><?php echo ($val['id']); ?></td>
											<td>
											...
											<td>
												<a href="#"><?php echo ($val['platename']); ?></a>
											</td>
											<td><?php echo ($val['ctime']); ?></td>
											<td><?php echo ($val['prisenum']); ?></td>
											<td><?php echo ($val['clicknum']); ?></td>
											<!-- <td>
												<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
													<button  class="btn btn-xs btn-del btn-danger" >
