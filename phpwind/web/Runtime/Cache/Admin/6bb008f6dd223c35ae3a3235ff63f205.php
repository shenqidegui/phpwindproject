	...
	<div class="main-content">
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li>
					<a href="<?php echo U('Admin/Cardstate/index');?>">帖子管理</a>
				</li>
				<li class="active">帖子状态修改</li>
			</ul><!-- .breadcrumb -->

			<div class="nav-search" id="nav-search">
				<form class="form-search" action='<?php echo U('Admin/Cardstate/update');?>' method='post'>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT BEGINS -->
					<form class="form-horizontal" role="form" action="<?php echo U('Admin/Cardstate/update');?>" method="post">
						<?php if(is_array($cardstates)): foreach($cardstates as $key=>$cardstates): ?><input type='hidden' name='cid' value="<?php echo ($cardstates['cid']); ?>"/>
                        <div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 标题</label>
							<div class="col-sm-9">
								<input type="text" readonly id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" name='title' value="<?php echo ($cardstates['title']); ?>"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="radio" id="form-field-1" placeholder="" name='is_show' value=0 <?php echo ($cardstates['is_show']? '' : 'checked'); ?>/>不显示
								<input type="radio" id="form-field-1" placeholder="" name='is_show' value=1 <?php echo ($cardstates['is_show']? 'checked' : ''); ?>/>显示
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 是否是精华帖</label>
							<div class="col-sm-9">
								<input type="radio" id="form-field-1" placeholder="" name='is_hot' value=0 <?php if($cardstates['is_hot'] == 0): ?>checked<?php endif; ?>/>普通帖
								<input type="radio" id="form-field-1" placeholder="" name='is_hot' value=1 <?php if($cardstates['is_hot'] == 1): ?>checked<?php endif; ?>/>精华帖
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 是否置顶显示</label>
							<div class="col-sm-9">
								<input type="radio" id="form-field-1" placeholder="" name='is_top' value=0 <?php if($cardstates['is_top'] == 0): ?>checked<?php endif; ?>/>不置顶
								<input type="radio" id="form-field-1" placeholder="" name='is_top' value=1 <?php if($cardstates['is_top'] == 1): ?>checked<?php endif; ?>/>置顶显示
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 审核状态</label>
							<div class="col-sm-9">
								<input type="radio" id="form-field-1" placeholder="" name='is_check' value=0 <?php if($cardstates['is_check'] == 0): ?>checked<?php endif; ?>/>不必审核
								<input type="radio" id="form-field-1" placeholder="" name='is_check' value=1 <?php if($cardstates['is_check'] == 1): ?>checked<?php endif; ?>/>审核中
								<input type="radio" id="form-field-1" placeholder="" name='is_check' value=2 <?php if($cardstates['is_check'] == 2): ?>checked<?php endif; ?>/>审核通过
								<input type="radio" id="form-field-1" placeholder="" name='is_check' value=3 <?php if($cardstates['is_check'] == 3): ?>checked<?php endif; ?>/>审核未通过
							</div>
