    ...
    <div class="page-content">
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <form method="post" action="<?php echo U('Admin/Sen/update');?>" role="form" class="form-horizontal">
            <input type="hidden" value="<?php echo ($val['id']); ?>" name="id">
              <div class="form-group">
                <label for="form-field-1" class="col-sm-3 control-label no-padding-right"> 敏感词</label>

                <div class="col-sm-9">
                  <input type="text" value="<?php echo ($val['word']); ?>" name="word" class="col-xs-10 col-sm-5" id="form-field-1">
                </div>
              </div>
              ...
              <div class="form-group">
                <label for="form-field-1" class="col-sm-3 control-label no-padding-right"> 等级 </label>
                    <!-- 词语查询等级：1禁用、2审核、3替换 -->
                <div class="col-sm-9">
                  <input type="radio" value="1" <?php if($val['grade'] == 1): ?>checked<?php endif; ?> name="grade" id="form-field-1">禁用
                  <input type="radio" value="2" <?php if($val['grade'] == 2): ?>checked<?php endif; ?> name="grade" id="form-field-1" >审核
                  <input type="radio" value="3" <?php if($val['grade'] == 3): ?>checked<?php endif; ?> name="grade" id="form-field-1">替换
                </div>
              </div>
