                           ...
                           <form role="form" action="<?php echo U('Admin/Cate/update');?>" method="post" enctype="multipart/form-data">
                               ...
                               <div class="form-group">
                                   ...
                                   <select name="pid" class="form-control">
                                      ...
                                      <?php if(is_array($cates)): foreach($cates as $k=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo["id"] == $info['pid'] ): ?>selected<?php endif; ?> ><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                                   </select>
                               </div>
