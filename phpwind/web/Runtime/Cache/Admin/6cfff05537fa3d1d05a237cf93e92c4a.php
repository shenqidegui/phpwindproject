...
<html lang="en">
						...
						<div class="col-xs-12">
							<div class="table-responsive">
								<table id="sample-table-1" class="table table-striped table-bordered table-hover">
									...
									<div class="row">
									  <div class="col-sm-6">
									    <div id="sample-table-2_length" class="dataTables_length">
									      <form action="<?php echo U('Admin/Sen/index');?>" method="get">
									      <label>每页显示 
									  ...
									  <div class="col-sm-6">
									    <div class="dataTables_filter" id="sample-table-2_filter">
									      <label>搜索: 
									        <input id="search" type="text" name="keyword" aria-controls="sample-table-2" placeholder="请输入标题" value="<?php echo ($_GET['keyword']); ?>">
									      </label>
									...
									<tbody>
									<?php if(is_array($cardstates)): foreach($cardstates as $key=>$cardstates): ?><tr>
											<td class="center">
												<label>
													<input type="checkbox" class="ace" />
													<span class="lbl"></span>
											...
											<td class="sid"><?php echo ($cardstates['cid']); ?></td>
											<td >
												<a href="<?php echo U('Admin/Card/index',array('id'=>$cardstates['cid']));?>"><?php echo ($cardstates['title']); ?></a>
											</td>
											<td>
												<?php switch($cardstates['is_show']): case "1": ?>显示<?php break;?>
												<?php case "0": ?>不显示<?php break;?>
												<?php default: ?>显示<?php endswitch;?>
											</td>
											<td>
											<!-- state状态：0待审、1普通、2置顶、3精华、-1未通过、9禁用 -->
											<?php switch($cardstates['is_hot']): case "0": ?>普通帖<?php break;?>
												<?php case "1": ?>精华帖<?php break;?>
												<?php default: ?>普通帖<?php endswitch;?>
											</td>
											<td>
												<?php switch($cardstates['is_top']): case "0": ?>不置顶<?php break;?>
												<?php case "1": ?>置顶显示<?php break;?>
												<?php default: ?>不置顶<?php endswitch;?>
											</td>
											<td>
												<?php switch($cardstates['is_check']): case "0": ?>不必审核<?php break;?>
												<?php case "1": ?>审核中<?php break;?>
												<?php case "2": ?>审核通过<?php break;?>
												<?php case "3": ?>审核未通过<?php break;?>
												<?php default: ?>不必审核<?php endswitch;?>
											</td>
											<td>
												<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
													<a href="<?php echo U('Admin/Cardstate/save',array('cid'=>$cardstates['cid']));?>" class="btn btn-xs btn-info">
    ...
    $('.btn-del').click(function(){
      ...
      var url = "<?php echo U('Admin/Cardstate/ajaxdel');?>";
      // alert(url);
      var btn = $(this);
      //ajax
