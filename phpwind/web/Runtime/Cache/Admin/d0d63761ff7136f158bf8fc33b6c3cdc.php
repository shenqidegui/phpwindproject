...
<html lang="en">
  ...
  <div class="main-content">
    ...
    <div class="page-content">
      ...
      <div class="row">
        <div class="col-xs-12">
          <form class="form-horizontal" role="form" action="<?php echo U('Admin/Type/insert');?>" method="post" enctype="multipart/form-data">
            <div class="form-group">
              <label for="form-field-1" class="col-sm-3 control-label no-padding-right"> 父级板块名称 </label>

              <div class="col-sm-9">
                <select id="form-field-select-1" name="pid" class="col-xs-10 col-sm-5">
                  <option value="0">顶级板块</option>
                  <?php if(is_array($plates)): foreach($plates as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>

            <div class="form-group">
              <label for="form-field-1" class="col-sm-3 control-label no-padding-right"> 新板块名称 </label>
