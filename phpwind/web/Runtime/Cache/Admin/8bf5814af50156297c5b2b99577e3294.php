                                   ...
                                   <div class="col-lg-6">
                                       <form role="form" action="<?php echo U('Admin/User/update');?>" method="post" enctype="multipart/form-data">
                                           ...
                                           <div class="form-group">
                                               <label>用户名</label>
                                               <input value="<?php echo ($info["username"]); ?>" name="username" placeholder="请输入6~18位数字,字母,下划线" class="form-control">
                                           </div>
                                           <div class="form-group">
                                               <label>密码</label>
                                               <input value="<?php echo ($info["password"]); ?>" type="password" name="password" placeholder="请输入6~18位数字,字母,下划线" class="form-control">
                                           </div>
                                           <div class="form-group">
                                               <label>邮箱</label>
