...
<html lang="en">
  ...
  <div class="main-content">
    ...
    <div class="page-content">
      ...
      <div style="z-index:999;width:500px;height:300px;position:fixed;top:60%;left:50%;margin:-160px 0px 0px -200px;background:#faf0e6;display:none" id="zidingyi">
            <!-- 敏感词添加表单 -->
          <form method="post" action="<?php echo U('Admin/Sen/insert');?>" role="form" class="form-horizontal">
                <!-- 添加敏感词 -->
            ...
            <div class="col-xs-12">
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover" id="sample-table-1">
                  ...
                  <tbody>
                  <?php if(is_array($sens)): foreach($sens as $k=>$vo): ?><tr>
                      <td class="void"><?php echo ($vo["id"]); ?></td>
                      <td class="vord"><?php echo ($vo["word"]); ?></td>
                      <td class="vode"><?php echo ($vo["grade"]); ?>
                      <!-- 词语查询等级：1禁用、2审核、3替换 -->
                      </td>
                      <td>
                        <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                            <!-- 修改按钮 -->
                          <a class="btn btn-xs btn-info" href="<?php echo U('Admin/Sen/save',array('id'=>$vo['id']));?>">
  ...
  $('.dele').click(function(){
    ...
    var url = "<?php echo U('Admin/Sen/del',array('id'=>$vo['id']));?>";
  ...
  //   // alert('ccc');
    // var num = $(this).val();
  //   var url = "<?php echo U('Admin/Sen/index');?>";
  //   // alert(num);
  //   var btn = $(this);
  //       //ajax
