                ...
                <div class="table-responsive">
                  <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <?php if(is_array($plates)): foreach($plates as $key=>$vo): ?><tr>                
                        ...
                        <td>
                          <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                            <a class="btn btn-xs btn-info" href="<?php echo U('Admin/Type/save',array('id'=>$vo['id']));?>">
                              <i class="icon-edit bigger-120"></i>
                            </a>
                                <!-- 删除 -->
                            <a class="btn btn-xs btn-danger" href="<?php echo U('Admin/Type/dele',array('id'=>$vo['id']));?>">
